...
// warning if no padLocalToken key found
if (configFile.padLocalToken === undefined) {
  console.error(
    "⚠️ No PAD_LOCAL_TOKEN found in env, please export to env or configure in config.yaml"
  );
}
...
export const Config: IConfig = {
  ...
  padLocalToken: configFile.padLocalToken,
};
